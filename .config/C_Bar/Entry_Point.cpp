    ...
    if (X_Generic_Event != nullptr)
    {
      ...
      //Left
      {
        ...
        Draw_Desktops_Label:
        {
          if (Desktop_Number != Desktops_Amount)
          {
            ...
            cairo_move_to(Cairo, 8 + Desktop_Number * 46, X_Screen_Height / 2 + 3);
      ...
      //Right
      {
        ...
        if ((X_Indicator_State & 4096) == 0)
        {
          ...
          cairo_move_to(Cairo, X_Screen_Width - Previous_Cairo_Text_Extents.width - 12, X_Screen_Height / 2 + 3);
        ...
        cairo_move_to(Cairo, X_Screen_Width - Previous_Cairo_Text_Extents.width - Cairo_Text_Extents.width - 22, X_Screen_Height / 2 + 3);
